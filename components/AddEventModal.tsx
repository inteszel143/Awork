...
export default function AddEventModal({ modalVisible, setModalVisible }: ModalProps) {
        ...
        >
            <View style={styles.modalStyle}>
                <View style={styles.modalBox}>
                    ...
                    <Text style={styles.updateTitle}>Add events</Text>
                    ...
                    <ScrollView>
                        ...
                        <TouchableOpacity style={[styles.saveBtn, { backgroundColor: !title && !desc ? '#DADADA' : '#00B4D8', }]}
                            ...
                            onPress={onSubmit}
                        >
                            {loading ? <ActivityIndicator size={'small'} color={'white'} /> : <Text style={styles.btnText}>Save</Text>}
                        </TouchableOpacity>
